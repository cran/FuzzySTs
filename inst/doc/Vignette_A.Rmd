---
title: "On fuzzification tools and fuzzy arithmetics"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{On fuzzification tools and fuzzy arithmetics}
...
Note that the decomposition in supposed to be in main-items and sub-items. This syntax is the same as the one used in the fuzzification process of the package `FuzzyToolkitUoN`.
